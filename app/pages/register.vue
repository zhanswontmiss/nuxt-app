  ...
  <div class="register-page p-4">
    <form class="flex flex-col gap-2 items-center" @submit.prevent="submitForm">
      <div class="flex gap-2 items-center justify-center">
        ...
        <input v-model="form.username" type="text" name="username" id="username" autocomplete="none" />
      </div>
      

      <div class="flex gap-2 items-center justify-center">
        <label for="password">Password: </label>
        <input v-model="form.password" type="password" name="password" id="password" autocomplete="none" />
      </div>
